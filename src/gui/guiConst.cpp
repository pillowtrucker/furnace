...
const char* insTypes[DIV_INS_MAX+1][3]={
  {"SN76489/Sega PSG",reinterpret_cast<const char *>(ICON_FA_BAR_CHART),reinterpret_cast<const char *>(ICON_FUR_INS_STD)},
  {"FM (OPN)",reinterpret_cast<const char *>(ICON_FA_AREA_CHART),reinterpret_cast<const char *>(ICON_FUR_INS_FM)},
  {"Game Boy",reinterpret_cast<const char *>(ICON_FA_GAMEPAD),reinterpret_cast<const char *>(ICON_FUR_INS_GB)},
  {"C64",reinterpret_cast<const char *>(ICON_FA_KEYBOARD_O),reinterpret_cast<const char *>(ICON_FUR_INS_C64)},
  {"Generic Sample",reinterpret_cast<const char *>(ICON_FA_VOLUME_UP),reinterpret_cast<const char *>(ICON_FUR_INS_AMIGA)},
  {"PC Engine",reinterpret_cast<const char *>(ICON_FA_ID_BADGE),reinterpret_cast<const char *>(ICON_FUR_INS_PCE)},
  {"AY-3-8910/SSG",reinterpret_cast<const char *>(ICON_FA_BAR_CHART),reinterpret_cast<const char *>(ICON_FUR_INS_AY)},
  {"AY8930",reinterpret_cast<const char *>(ICON_FA_BAR_CHART),reinterpret_cast<const char *>(ICON_FUR_INS_AY8930)},
  {"TIA",reinterpret_cast<const char *>(ICON_FA_BAR_CHART),reinterpret_cast<const char *>(ICON_FUR_INS_TIA)},
  {"SAA1099",reinterpret_cast<const char *>(ICON_FA_BAR_CHART),reinterpret_cast<const char *>(ICON_FUR_INS_SAA1099)},
  {"VIC",reinterpret_cast<const char *>(ICON_FA_BAR_CHART),reinterpret_cast<const char *>(ICON_FUR_INS_VIC)},
  {"PET",reinterpret_cast<const char *>(ICON_FA_SQUARE),reinterpret_cast<const char *>(ICON_FUR_INS_PET)},
  {"VRC6",reinterpret_cast<const char *>(ICON_FA_BAR_CHART),reinterpret_cast<const char *>(ICON_FUR_INS_VRC6)},
  {"FM (OPLL)",reinterpret_cast<const char *>(ICON_FA_AREA_CHART),reinterpret_cast<const char *>(ICON_FUR_INS_OPLL)},
  {"FM (OPL)",reinterpret_cast<const char *>(ICON_FA_AREA_CHART),reinterpret_cast<const char *>(ICON_FUR_INS_OPL)},
  {"FDS",reinterpret_cast<const char *>(ICON_FA_FLOPPY_O),reinterpret_cast<const char *>(ICON_FUR_INS_FDS)},
  {"Virtual Boy",reinterpret_cast<const char *>(ICON_FA_BINOCULARS),reinterpret_cast<const char *>(ICON_FUR_INS_VBOY)},
  {"Namco 163",reinterpret_cast<const char *>(ICON_FA_CALCULATOR),reinterpret_cast<const char *>(ICON_FUR_INS_N163)},
  {"Konami SCC/Bubble System WSG",reinterpret_cast<const char *>(ICON_FA_CALCULATOR),reinterpret_cast<const char *>(ICON_FUR_INS_SCC)},
  {"FM (OPZ)",reinterpret_cast<const char *>(ICON_FA_AREA_CHART),reinterpret_cast<const char *>(ICON_FUR_INS_OPZ)},
  {"POKEY",reinterpret_cast<const char *>(ICON_FA_BAR_CHART),reinterpret_cast<const char *>(ICON_FUR_INS_POKEY)},
  {"Beeper",reinterpret_cast<const char *>(ICON_FA_SQUARE),reinterpret_cast<const char *>(ICON_FUR_INS_BEEPER)},
  {"WonderSwan",reinterpret_cast<const char *>(ICON_FA_GAMEPAD),reinterpret_cast<const char *>(ICON_FUR_INS_SWAN)},
  {"Atari Lynx",reinterpret_cast<const char *>(ICON_FA_BAR_CHART),reinterpret_cast<const char *>(ICON_FUR_INS_MIKEY)},
  {"VERA",reinterpret_cast<const char *>(ICON_FA_KEYBOARD_O),reinterpret_cast<const char *>(ICON_FUR_INS_VERA)},
  {"X1-010",reinterpret_cast<const char *>(ICON_FA_BAR_CHART),reinterpret_cast<const char *>(ICON_FUR_INS_X1_010)},
  {"VRC6 (saw)",reinterpret_cast<const char *>(ICON_FA_BAR_CHART),reinterpret_cast<const char *>(ICON_FUR_INS_VRC6_SAW)},
  {"ES5506",reinterpret_cast<const char *>(ICON_FA_VOLUME_UP),reinterpret_cast<const char *>(ICON_FUR_INS_ES5506)},
  {"MultiPCM",reinterpret_cast<const char *>(ICON_FA_VOLUME_UP),reinterpret_cast<const char *>(ICON_FUR_INS_MULTIPCM)},
  {"SNES",reinterpret_cast<const char *>(ICON_FA_VOLUME_UP),reinterpret_cast<const char *>(ICON_FUR_INS_SNES)},
  {"Sound Unit",reinterpret_cast<const char *>(ICON_FA_MICROCHIP),reinterpret_cast<const char *>(ICON_FUR_INS_SU)},
  {"Namco WSG",reinterpret_cast<const char *>(ICON_FA_PIE_CHART),reinterpret_cast<const char *>(ICON_FUR_INS_NAMCO)},
  {"OPL (drums)",reinterpret_cast<const char *>(ICON_FA_COFFEE),reinterpret_cast<const char *>(ICON_FUR_INS_OPL_DRUMS)},
  {"FM (OPM)",reinterpret_cast<const char *>(ICON_FA_AREA_CHART),reinterpret_cast<const char *>(ICON_FUR_INS_OPM)},
  {"NES",reinterpret_cast<const char *>(ICON_FA_GAMEPAD),reinterpret_cast<const char *>(ICON_FUR_INS_NES)},
  {"MSM6258",reinterpret_cast<const char *>(ICON_FA_VOLUME_UP),reinterpret_cast<const char *>(ICON_FUR_INS_MSM6258)},
  {"MSM6295",reinterpret_cast<const char *>(ICON_FA_VOLUME_UP),reinterpret_cast<const char *>(ICON_FUR_INS_MSM6295)},
  {"ADPCM-A",reinterpret_cast<const char *>(ICON_FA_VOLUME_UP),reinterpret_cast<const char *>(ICON_FUR_INS_ADPCMA)},
  {"ADPCM-B",reinterpret_cast<const char *>(ICON_FA_VOLUME_UP),reinterpret_cast<const char *>(ICON_FUR_INS_ADPCMB)},
  {"SegaPCM",reinterpret_cast<const char *>(ICON_FA_VOLUME_UP),reinterpret_cast<const char *>(ICON_FUR_INS_SEGAPCM)},
  {"QSound",reinterpret_cast<const char *>(ICON_FA_VOLUME_UP),reinterpret_cast<const char *>(ICON_FUR_INS_QSOUND)},
  {"YMZ280B",reinterpret_cast<const char *>(ICON_FA_VOLUME_UP),reinterpret_cast<const char *>(ICON_FUR_INS_YMZ280B)},
  {"RF5C68",reinterpret_cast<const char *>(ICON_FA_VOLUME_UP),reinterpret_cast<const char *>(ICON_FUR_INS_RF5C68)},
  {"MSM5232",reinterpret_cast<const char *>(ICON_FA_BAR_CHART),reinterpret_cast<const char *>(ICON_FUR_INS_MSM5232)},
  {"T6W28",reinterpret_cast<const char *>(ICON_FA_BAR_CHART),reinterpret_cast<const char *>(ICON_FUR_INS_T6W28)},
  {"K007232",reinterpret_cast<const char *>(ICON_FA_BAR_CHART),reinterpret_cast<const char *>(ICON_FUR_INS_K007232)},
  {"GA20",reinterpret_cast<const char *>(ICON_FA_BAR_CHART),reinterpret_cast<const char *>(ICON_FUR_INS_GA20)},
  {"Pokémon Mini/QuadTone",reinterpret_cast<const char *>(ICON_FA_BAR_CHART),reinterpret_cast<const char *>(ICON_FUR_INS_POKEMINI)},
  {"SM8521",reinterpret_cast<const char *>(ICON_FA_GAMEPAD),reinterpret_cast<const char *>(ICON_FUR_INS_SM8521)},
  {"PV-1000",reinterpret_cast<const char *>(ICON_FA_GAMEPAD),reinterpret_cast<const char *>(ICON_FUR_INS_PV1000)},
  {"K053260",reinterpret_cast<const char *>(ICON_FA_BAR_CHART),reinterpret_cast<const char *>(ICON_FUR_INS_K053260)},
  {"SCSP",reinterpret_cast<const char *>(ICON_FA_QUESTION),reinterpret_cast<const char *>(ICON_FUR_INS_SCSP)},
  {"TED",reinterpret_cast<const char *>(ICON_FA_BAR_CHART),reinterpret_cast<const char *>(ICON_FUR_INS_TED)},
  {"C140",reinterpret_cast<const char *>(ICON_FA_VOLUME_UP),reinterpret_cast<const char *>(ICON_FUR_INS_C140)},
  {"C219",reinterpret_cast<const char *>(ICON_FA_VOLUME_UP),reinterpret_cast<const char *>(ICON_FUR_INS_C219)},
  {"FM (ESFM)",reinterpret_cast<const char *>(ICON_FA_AREA_CHART),reinterpret_cast<const char *>(ICON_FUR_INS_ESFM)},
  {"PowerNoise (noise)",reinterpret_cast<const char *>(ICON_FUR_NOISE),reinterpret_cast<const char *>(ICON_FUR_INS_POWERNOISE)},
  {"PowerNoise (slope)",reinterpret_cast<const char *>(ICON_FUR_SAW),reinterpret_cast<const char *>(ICON_FUR_INS_POWERNOISE_SAW)},
  {"Dave",reinterpret_cast<const char *>(ICON_FA_BAR_CHART),reinterpret_cast<const char *>(ICON_FUR_INS_DAVE)},
  {"Nintendo DS",reinterpret_cast<const char *>(ICON_FA_BAR_CHART),reinterpret_cast<const char *>(ICON_FUR_INS_NDS)},
  {"GBA DMA",reinterpret_cast<const char *>(ICON_FA_GAMEPAD),reinterpret_cast<const char *>(ICON_FUR_INS_GBA_DMA)},
  {"GBA MinMod",reinterpret_cast<const char *>(ICON_FA_VOLUME_UP),reinterpret_cast<const char *>(ICON_FUR_INS_GBA_MINMOD)},
  {NULL,reinterpret_cast<const char *>(ICON_FA_QUESTION),reinterpret_cast<const char *>(ICON_FA_QUESTION)}
};
